  ...
  it('非理想状态处理', function() {
    ...
    const vnode2 = {
      ...
      children: [
        ...
        { type: 'p', children: '4-4', key: 4 },
        { type: 'p', children: '2-2', key: 2 },
        { type: 'p', children: '7-7', key: 7 },
        { type: 'p', children: '5-5', key: 5 },
      ]
    }

    domRenderer.render(vnode1, root)
    expect(root.innerHTML).toBe('<div><p>1</p><p>2</p><p>3</p><p>4</p><p>6</p><p>5</p></div>')
    domRenderer.render(vnode2, root)
    expect(root.innerHTML).toBe('<div><p>1-1</p><p>3-3</p><p>4-4</p><p>2-2</p><p>7-7</p><p>5-5</p></div>')
  });
});
